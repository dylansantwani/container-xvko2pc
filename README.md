...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-xvko2pc.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-xvko2pc.containers.anotherwebservice.com/
...
```
git clone git@github.com:dylansantwani/container-xvko2pc.git
cd container-xvko2pc
```
...
```
docker attach container-xvko2pc
```
